export default {
  ...
  create_token: {
    ...
    name: 'Token Name',
    symbol: 'Token Symbol',
    decimal: 'Decimals (It\'s recommended to set decimals to 8 in ALV)',
  ...
  restore_ledger: {
    ...
    usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open Alvey APP, and then click the "CONNECT" button below try to connect.',
    download: 'No Alvey APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
    connect: 'CONNECT'
  },
  view: {
